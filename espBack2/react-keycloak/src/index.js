...
function CheckRoles() {
  const check = () => {
    $.ajax({
      ...
      error: function (error) {
        document.getElementById("admin").innerHTML = "You dont have admin privileges";
      }
    });
    ...
    $.ajax({
      ...
      error: function (error) {
        document.getElementById("cust").innerHTML = "You dont have customer privileges";
      }
    });
  ...
  return (
    <>
      <p> Check Admin privileges at <strong>/check/admin</strong> and check Customer privileges at <strong>/check/customer</strong>
      </p>
